...
public class SuscripcionService {
	...
	/**
	 * Busca suscripciones activas que vencen en una fecha concreta
	 */
	public List<Suscripcion> buscarSuscripcionesPorFechaRenovacion(LocalDate fecha) {
	    return suscripcionRepository.findByProximaRenovacionAndEstado(fecha, EstadoSuscripcion.ACTIVA);
	}
}
